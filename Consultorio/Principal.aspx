...
(function ($) {
  ...
  ;(function (defaults, $, window, document) {
    ...
    var citasjson = JSON.parse(JSON.stringify(variableServidor));
    var data = [];

    for (var i in citasjson) {
        data.push({ title: citasjson[i].Titulo, start: new Date(citasjson[i].Ano, citasjson[i].Mes, citasjson[i].Dia, citasjson[i].Hora, citasjson[i].Minutos), end: new Date(citasjson[i].Ano, citasjson[i].Mes, citasjson[i].Dia, citasjson[i].Hora, (citasjson[i].Minutos+30)), allDay: false, text: citasjson[i].Mensaje  });
    }
